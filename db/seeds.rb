...
Question.create([
    ...
    },
    {
        ...
        answers: ["give up loyalty to other countries","defend the Constitution and laws of the United States","obey the laws of the United States","serve in the U.S. military (if needed)","be loyal to the United States"]
    },
    {
    ...
    },
    {
        ...
        answers: ["vote","join a political party","help with a campaign","join a civic group","give an elected official your opinion on an issue", "call Senators and Representatives","publicly support or oppose an issue or policy","run for office","write to a newspaper"]
    },
    {
    ...
    {
        question: "Name of the U.S. war between the North and South.",
        answers: ["the Civl War","the War between the states"]
    },
    {
        question: "Name one problem that led to the Civil War.",
        answers: ["slavery","economic","state's rights"]
    },
    {
    ...
    },
    {
        ...
        answers: ["World War I","World War II","Korean","Vietnam War", "(Persian) Gulf War"]
    },
    {
    ...
    {
        question: "What movement tried to end racial dsicrimination",
    ...
    {
        question: "What major event happend on September 11, 2001, in the United States?",
        answers: ["Terrorists attacked the United States."]
    },
    {
        question: "Name one American tribe in the United States.",
